...
const straightLineCatItemSchema: LeafPaletteItemSchema[] = [
  ...
  {
    shapeType: ShapeType.STRAIGHT_LINE_AFV$1C,
    iconElement: <img src={afv$1cIcon} alt="afv$c" width="20px" />,
    nested: false,
  },
  {
    shapeType: ShapeType.STRAIGHT_LINE_AF_V$1C,
    iconElement: <img src={af_v$1cIcon} alt="af_v$c" width="20px" />,
    nested: false,
  },
];
...
const curvedLineCatItemSchema: LeafPaletteItemSchema[] = [
  ...
  {
    shapeType: ShapeType.STRAIGHT_LINE_AFC$2C,
    iconElement: <img src={afc$2cIcon} alt="afc$2c" width="15px" />,
    nested: false,
  },
  {
    shapeType: ShapeType.STRAIGHT_LINE_AF_C$2C,
    iconElement: <img src={af_c$2cIcon} alt="af_c$2c" width="15px" />,
    nested: false,
  },
  {
...
export const paletteItemSchema: PaletteItemSchemaType[] = [
  ...
  {
    iconElement: <img src={afv$1cIcon} alt="afv$1c" width="23px" />,
    nested: true,
